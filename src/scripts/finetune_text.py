...
def run(cfg: DictConfig):
    ...
    if cfg.reset_classification_head:
        classification_head = get_classification_head(
            input_size=cfg.nn.module.model.hidden_size, num_classes=cfg.nn.data.dataset.num_classes
        )
    ...
    if cfg.ft_on_data_split == "train":
        ...
        raise ValueError(
            f'Unknown data split to fine-tune on: {cfg.ft_on_data_split}. Possible values: "train" or "val"'
        )
